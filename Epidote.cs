    ...
    public partial class DashboardUI : Form
    {
        ...
        private void melonLauncher_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (!File.Exists(melonclient))
            {
                ...
                letoltes.DownloadFile("[LINK]/mc.jar", epidoteLauncher + @"\mc.jar");
                letoltes.DownloadFile("[LINK]/MelonClient-0.1-BETA.jar", epidoteMelonclient + @"\MelonClient-0.1-BETA.jar");
            }
        ...
        private void cheatbreakerLauncher_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (!File.Exists(cheatbreaker))
            {
                ...
                letoltes.DownloadFile("[LINK]/cb.jar", epidoteLauncher + @"\cb.jar");
            }
        ...
        private void batmodLauncher_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (!File.Exists(batmod))
            {
                ...
                letoltes.DownloadFile("[LINK]/bm.jar", epidoteLauncher + @"\bm.jar");
                letoltes.DownloadFile("[LINK]/BatMod.jar", epidoteBadmodclient + @"\BatMod.jar");
            }
